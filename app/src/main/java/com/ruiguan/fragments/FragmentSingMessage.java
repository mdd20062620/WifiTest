...
import com.ruiguan.storage.FragmentButtonData;
...
public class FragmentSingMessage {
    ...
    public Handler getSendFragmentHandler() {
    ...
    public void setReceiveFragMessageHandler(Handler mReceiveFragMessageHandler) {
