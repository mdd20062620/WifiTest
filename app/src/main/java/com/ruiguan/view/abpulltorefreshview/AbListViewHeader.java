...
public class AbListViewHeader extends AbListViewBaseHeader {
    ...
    private void initView() {
        ...
        ViewUtils.setPadding(headerView, 0, 10, 0, 10);
        ...
        //箭头图片
        arrowImageView.setImageResource(R.drawable.add);
        ...
        layoutParamsWW.width = ViewUtils.scaleValue(context, 50);
        layoutParamsWW.height = ViewUtils.scaleValue(context, 50);
        ...
        ViewUtils.setTextSize(headerTimeView,27);
        ...
        layoutParamsWW3.rightMargin = ViewUtils.scaleValue(context, 10);
