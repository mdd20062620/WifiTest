...
public class AbListViewFooter extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        footerView.setMinimumHeight(ViewUtils.scaleValue(mContext,100));
        footerTextView = new TextView(context);
        footerTextView.setGravity(Gravity.CENTER_VERTICAL);
        setTextColor(Color.rgb(107, 107, 107));
        ViewUtils.setTextSize(footerTextView,30);

        ViewUtils.setPadding(footerView, 0, 10, 0, 10);
        ...
        layoutParamsWW.width = ViewUtils.scaleValue(mContext, 50);
        layoutParamsWW.height = ViewUtils.scaleValue(mContext, 50);
        layoutParamsWW.rightMargin = ViewUtils.scaleValue(mContext, 10);
